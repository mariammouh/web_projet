    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="card-header"><h1>Hello again {{ Auth::user()->name }}</h1></div>
                ...
                <div class="card-body">
                    ...
                    <br />
                    <form action="{{ route('show_list', Auth::user()->id) }}" method="get">
                        @csrf
                        <button type="submit"  class="submit">Your watch list</button>
                    </form>
                    <br />
                    <form action="{{ route('top_list') }}" method="post">
                        @csrf
                        <button type="submit"  class="submit">Top rating</button>
                    </form>
                    {{-- <form action="{{ route('top_watch') }}" method="post">
                        @csrf
                        <button type="submit"  class="submit">Top watching</button>
                    </form> --}}
                    <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header"><h1>{{ __('Our shows') }}</h1></div>
